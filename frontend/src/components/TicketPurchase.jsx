            ...
            <div className="theme-park-grid">
              {ticketTypes.map((ticket, index) => (
                <div
                  ...
                  className={`theme-park-price-card ${
                    index === 1 ? "featured" : ""
                  }`}
                ...
                >
                  {index === 1 && (
                    <div className="theme-park-price-badge">🔥 BEST VALUE</div>
                  )}
                  ...
                  <h3
                    style={{
                      ...
                      fontWeight: "700",
                      marginBottom: "15px",
                      color: index === 1 ? "white" : "var(--text-dark)",
                    }}
                  >
                    {ticket.typeName}
                  </h3>
                  ...
                  <button
                    className={
                      index === 1
                        ? "theme-park-btn theme-park-btn-secondary w-full"
                        : "theme-park-btn theme-park-btn-primary w-full"
                    }
          ...
          <div className="theme-park-card">
            ...
            >
              ...
              >
                <div>
                  ...
                  >
                    {getTicketIcon(selectedTicket.typeName)}{" "}
            ...
            <form onSubmit={handlePurchase} className="theme-park-form">
              ...
              >
                {loading
                  ? "⏳ Processing..."
                  : `🎉 Purchase for $${selectedTicket.price}`}
              </button>
            </form>
          </div>
        )}
